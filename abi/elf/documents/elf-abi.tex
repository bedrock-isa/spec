...
The loader clears \texttt{FLAGS}, \texttt{FSTATUS}, and \texttt{FFLAGS}.
...
\BedrockGeneratedElfEntryStateTable
...
\manualtablecaption{Relocation Metasyntax Vocabulary}
\begingroup\footnotesize
\setlength{\tabcolsep}{2pt}
...
\BedrockGeneratedElfRelocationRows
...
\BedrockGeneratedElfDebugRegisterTable
...
packed image with its exact architectural byte count.
