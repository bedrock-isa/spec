...
The baseline ABI uses the natural aggregate layout above. Packed aggregates,
\texttt{\#pragma pack}, empty structures, and zero-length arrays have no
external calling or object-layout contract in this ABI.
...
packed or unaligned members is outside this ABI contract.
