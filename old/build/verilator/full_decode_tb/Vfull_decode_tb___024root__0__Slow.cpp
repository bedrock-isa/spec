...
VL_ATTR_COLD void Vfull_decode_tb___024root___eval_static(Vfull_decode_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfull_decode_tb___024root___eval_static\n"); );
...
VL_ATTR_COLD void Vfull_decode_tb___024root___eval_final(Vfull_decode_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfull_decode_tb___024root___eval_final\n"); );
    Vfull_decode_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}
...
VL_ATTR_COLD void Vfull_decode_tb___024root___eval_settle(Vfull_decode_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfull_decode_tb___024root___eval_settle\n"); );
    Vfull_decode_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
#endif
            VL_FATAL_MT("tb/full_decode_tb.sv", 4, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        vlSelfRef.__VstlPhaseResult = Vfull_decode_tb___024root___eval_phase__stl(vlSelf);
        vlSelfRef.__VstlFirstIteration = 0U;
    } while (vlSelfRef.__VstlPhaseResult);
}

VL_ATTR_COLD void Vfull_decode_tb___024root___eval_triggers_vec__stl(Vfull_decode_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfull_decode_tb___024root___eval_triggers_vec__stl\n"); );
    Vfull_decode_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vfull_decode_tb___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfull_decode_tb___024root___dump_triggers__stl\n"); );
    // Body
    if ((1U & (~ (IData)(Vfull_decode_tb___024root___trigger_anySet__stl(triggers))))) {
...
VL_ATTR_COLD bool Vfull_decode_tb___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfull_decode_tb___024root___trigger_anySet__stl\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
VL_ATTR_COLD void Vfull_decode_tb___024root___stl_sequent__TOP__0(Vfull_decode_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfull_decode_tb___024root___stl_sequent__TOP__0\n"); );
    Vfull_decode_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
VL_ATTR_COLD void Vfull_decode_tb___024root___ctor_var_reset(Vfull_decode_tb___024root* vlSelf) {
    ...
    vlSelf->full_decode_tb__DOT__field_format_id = VL_SCOPED_RAND_RESET_I(7, __VscopeHash, 11996878751201639730ull);
