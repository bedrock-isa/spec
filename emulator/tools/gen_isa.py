...
PREDICATE_VALUES = {
    "rn_direct": set(range(0x00, 0x10)),
    "sp_direct": {0x68},
    "reg_direct": set(range(0x00, 0x10)) | {0x68},
...
def render(isa_design: Path) -> str:
    ...
    source_hash = digest_inputs(source_paths + definition_paths)
    out = [
