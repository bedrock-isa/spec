/* Requires a u8 typedef before inclusion. */
#ifndef BEDROCK_SAMPLES_COMMON_FONT8X8_H
#define BEDROCK_SAMPLES_COMMON_FONT8X8_H

static const u8 BEDROCK_FONT8X8[95][8] = {
    ...
    {0x00, 0x00, 0x30, 0x4a, 0x06, 0x00, 0x00, 0x00}, /* ~ */
};
