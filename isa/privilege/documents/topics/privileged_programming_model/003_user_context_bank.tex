...
Software stages a context by writing UPC, USP, UCS, UDS, USS, and UINFO before writing UCTL.V=1. That final write validates the complete bank. The bank belongs to the interrupted user (:term:base.terms.thread:) and must be saved with its supervisor context across preemption or migration.
