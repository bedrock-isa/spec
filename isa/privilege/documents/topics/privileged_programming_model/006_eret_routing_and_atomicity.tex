...
ERET classifies its source before any stack access. PM=1, EA=0, EDEPTH=0, UO=0, and UCTL.V=1 performs direct initial user entry from the bank. PM=1, EA=1, EDEPTH=1, UO=1, and UCTL.V=1 returns the outer user event from the bank. Other supervisor states with EA=1 and nonzero EDEPTH restore a full frame from the current SS:SP. Every other combination raises (:ref:base.events.EXCEPTION.INVALID_CONTROL_TRANSITION:).
