...
\item Execution-stage integer faults and enabled (:term:base.terms.floating_point_exception_condition|plural:) that raise
(:ref:FP.events.EXCEPTION.FLOATING_POINT_EXCEPTION:).
\end{enumerate}
