...
SETF, CLRF, WRFLAGS, CMPXCHG, and the bounds-check instructions. CMPJcc and TESTJcc compute temporary condition flags
...
Conditional branches, calls, traps, sets, and repeat instructions consume the condition-code table without recomputing
