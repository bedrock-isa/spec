...
value (:term:base.terms.must_be_zero:). Bits \texttt{57..56} are (:ref:base.memory.translation.PTE.SW:)\texttt{[1:0]} and are (:term:base.terms.ignored:)
...
(:pte-field-target:base.memory.translation.PTE.PFN:)\texttt{PFN} & \texttt{55..12} & mapped (:term:base.terms.physical_frame_number:)\\
...
(:ref:base.memory.translation.PTE.PFN:) & \texttt{55..12} & next-table (:term:base.terms.physical_frame_number:)\\
...
The leaf alone supplies (:ref:base.memory.translation.PTE.G:), (:ref:base.memory.translation.PTE.CP:), and Normal/MMIO class. A leaf at level $L$ must
