...
\node[draw,align=center,minimum width=0.82in,minimum height=0.34in,inner sep=1.5pt] (tbl0) at (1.75,4.78) {16-KiB L4\\table object};
...
\node[draw,align=center,minimum width=0.82in,minimum height=0.34in,inner sep=1.5pt] (tbl1) at (1.75,4.08) {16-KiB L3\\table object};
...
\node[draw,align=center,minimum width=0.82in,minimum height=0.34in,inner sep=1.5pt] (tbl2) at (1.75,3.38) {16-KiB L2\\table object};
...
\node[draw,align=center,minimum width=0.82in,minimum height=0.34in,inner sep=1.5pt] (tbl3) at (1.75,2.68) {4-KiB L1\\table object};
...
\node[draw,align=left,minimum width=4.55in,inner sep=2.5pt] at (3.02,1.20) {Maximum-depth walk shown. At L4 through L2, (:ref:base.memory.translation.PTE.T:)\texttt{=1} continues and (:ref:base.memory.translation.PTE.T:)\texttt{=0} terminates at an aligned byte leaf;\\upper table transitions require 16-KiB alignment, while L2-to-L1 consumes the full 4-KiB-aligned (:ref:base.memory.translation.PTE.NEXT_TABLE:).};
\end{tikzpicture}
\par
