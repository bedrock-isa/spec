...
\node[box,minimum width=2.00cm] (page) at (10.65,0.95) {(:ref:base.control_registers.PTCR.PE:)\texttt{=1}\\page-table\\translation};
\node[box,minimum width=2.00cm] (direct) at (10.65,-0.95) {(:ref:base.control_registers.PTCR.PE:)\texttt{=0}\\use linear\\directly};
