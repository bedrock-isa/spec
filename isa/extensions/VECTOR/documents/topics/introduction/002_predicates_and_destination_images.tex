...
predicate image.  It sets or clears each significant result bit and clears all
bits outside the typed predicate image.  Integer comparisons support \texttt{EQ},
