...
operation treats the current VLEN as divided by the selected element width lanes.
...
error code one and commits no state.  (:ref:VECTOR.instructions.VLCNT:) returns the current VLEN in bytes
