...
The \texttt{FPTRANSA} predicate requires \texttt{FP} and reports that at least one approximate transcendental
...
\texttt{PRESENT=1} establishes the accuracy contract for both S and D encodings but does not waive the
...
Executing the instruction with \texttt{PRESENT=0} raises (:ref:base.events.EXCEPTION.INVALID_OPERAND_RELATION:)
