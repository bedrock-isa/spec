...
Each instruction names its required \texttt{FPTRANSA\_ACCURACY} contract. A clear \texttt{PRESENT} (:term:base.terms.field:) for that
...
An approximate transcendental operation is available only when CPUID reports \texttt{FPTRANSA} and marks that
