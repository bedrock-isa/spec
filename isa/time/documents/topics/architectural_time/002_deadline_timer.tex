...
operations. The timer state has no control-register or state-record projection.
...
must be from 1 through (:ref:base.control_registers.ICAP.MAX_ID:). An invalid identity raises
...
Expiry posts pending state regardless of the identity\textquotesingle{}s enable bit, ITHRESH, (:ref:base.registers.STATE.STATUS.IE:), (:ref:base.control_registers.ECR.V:), or
