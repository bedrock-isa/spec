...
An encoded FEA source \texttt{immsf} is an exact IEEE 754 binary32 payload, and \texttt{immdf} is an exact
binary64 payload. Either immediate may be used by either an S or D instruction. If the payload format differs from
