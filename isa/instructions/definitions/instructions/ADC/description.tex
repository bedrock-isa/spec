Adds the selected-width source value and the incoming C flag to the destination, writes the truncated sum, and updates Z, N, C, and V from the complete addition. REPcc observes the written destination result rather than architectural FLAGS.
