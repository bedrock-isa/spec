...
\begin{enumerate}
\item Require LPA.A to be zero, then evaluate the target operand completely in the old architectural context.
...
An active resident link raises (:ref:base.events.EXCEPTION.INVALID_CONTROL_TRANSITION:) before target or stack access.
