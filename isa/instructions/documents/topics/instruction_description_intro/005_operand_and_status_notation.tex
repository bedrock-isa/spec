...
constant result. \texttt{*} marks the single table-defined effect described by that table\textquotesingle{}s local legend. When a table
contains multiple table-defined effects, letters \texttt{a} through \texttt{z} distinguish their local legend entries.
