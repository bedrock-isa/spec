...
FLAGS, STATUS, FFLAGS, and FSTATUS are (:term:base.terms.architectural_state:) registers. Instruction descriptions state whether an
...
the accrued (:term:base.terms.floating_point_exception_flag|plural:).
