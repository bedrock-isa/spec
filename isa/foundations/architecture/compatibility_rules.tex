...
Software-defined fields form a separate software-use category. Software may store values in them, and hardware
ignores them except where the containing structure explicitly says otherwise.

\input{isa/foundations/architecture/reserved_field_defaults.tex}
