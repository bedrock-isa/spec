...
\midrule
\endhead
\texttt{cpuid\_higher\_classes} & CPUID Feature Discovery, Base Identity and Leaf Directory & CPUID class and leaf directories plus implementation documentation for the class payload\\
\texttt{performance\_counter\_ids} & CPUID Performance-Counter Discovery and RDPMC & CPUID PERFORMANCE\_COUNTERS presence results plus implementation documentation naming each counter event\\
\texttt{event\_aux\_syndrome} & Machine-check EVENT\_AUX payload & platform documentation or firmware interface documentation for the event source\\
\texttt{fptransa\_approximation} & FPTRANSA Common Model and CPUID accuracy contracts & CPUID accuracy-contract discovery plus implementation documentation for the deterministic approximation\\
\bottomrule
\end{manuallongtable}
