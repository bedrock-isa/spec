...
coordinates. A conforming execution maintains all of the following invariants:
...
operations but is not required to designate storage and is never dereferenced.
...
The 64-bit all-zero null-pointer representation remains unchanged, and address
zero is not assigned to a C object or function. The platform ABI defines a
null-guard size of at least 4096 bytes. Every pointer coordinate below that
size is invalid through each segment path that can perform an ordinary C
access.
...
\input{isa/interfaces/abi/c/documented_calling_convention_case_registry.tex}
\input{isa/interfaces/abi/c/return_register_quick_reference.tex}
...
\input{isa/interfaces/abi/c/call_relocation_quick_reference.tex}
...
\input{isa/interfaces/abi/c/ordinary_memory_access_guarantees.tex}
...
\input{isa/interfaces/abi/c/native_atomic_primitive_quick_reference.tex}
