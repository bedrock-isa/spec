...
\textbf{Bits} & \textbf{Field} & \textbf{Meaning}\\
\midrule
\texttt{31..0} & (:cpuid-field-target:base.cpuid.IMPLEMENTATION.SAVE_AREA_LAYOUT.COMPONENT_DESCRIPTOR_B.MAX_SIZE_BYTES:)\texttt{MAX\_SIZE\_BYTES} & maximum component size\\
