...
the repeat counter is left unchanged. The instruction set does not define an
architected vector register file for these operations, and software must not
...
instruction. If the ENDG marker is absent before the end of the grouping window,
the instruction stream is illegal. ENDG by itself is also illegal, because it is
only a boundary marker for an active REPG group.
