...
The \texttt{REPcc observation} attribute in every REPcc-capable instruction description selects one observation. A
\texttt{flags} observation uses the complete post-body FLAGS image. A \texttt{result:operand} or
...
restores that state atomically with the saved PC and status state. TF and RF apply to the trace units defined by the
