...
\begin{itemize}
\item the repeated body is decoded when repeat state is entered and remains the body for that repeat context;
\item body decode and repeatability checks occur before zero-count annulment;
...
\item faults and exceptions are precise at the repeated-operation boundary defined by the repeat instruction rule;
...
@REPEATABLE_CLASS_TABLE@

@REPEAT_BODY_ENTRY_TABLE@

\subsection{Counter, Condition, and Control Rules}

@REPEAT_COUNTER_TABLE@

@REPEAT_LEGALITY_TABLE@
