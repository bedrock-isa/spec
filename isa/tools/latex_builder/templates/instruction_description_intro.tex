...
consumed by the opcode and selected operand payloads. Every larger encoded length through 18 bytes is valid and the
trailing bytes are uninterpreted padding. The \texttt{LEN n,} spelling records an explicit total length.
\clearpage
