...
condition-code selector, then applies that repeat contract to the following eligible instruction. REP is the
...
\begingroup\small\ttfamily
\begin{tabular}{@{}l@{}}
; D0 = -n, A0 = byte source + n, A1 = long destination + 4*n\\
REP D0, EXTZL.B [A0 + D0 * 1], [A1 + D0 * 4]\\
\end{tabular}
\endgroup
\end{quote}
