...
A \emph{far data address} is a C data-address pair containing a canonical post-segment virtual address and a
...
A \emph{control register} is a privileged register exposed through the CR operand class, such as PTCR, ASCR, ICR,
SPC, SCS, and SDS.
