...
A \emph{PFN} is a physical frame number. A leaf PTE combines its PFN with linear-address bits 11..0 to form a byte
address when \texttt{AT=0} or a slot address when \texttt{AT=1}.
