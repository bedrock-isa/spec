\clearpage
\section{Terminology and Compatibility}\label{section:terminology}
...
\texttt{AT=0}. The PTE \texttt{CP} field selects one of its four normal-memory cache policies. \emph{Cacheable}
names only policy \texttt{CP=0}; the other three \texttt{CP} values remain byte-addressed normal memory with the
