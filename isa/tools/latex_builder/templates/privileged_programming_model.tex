...
identical. In supervisor mode, explicit \texttt{U:} and \texttt{C:} operand annotations determine whether the
generated prefix asks for user-domain access.
...
architecturally named fault and do not partially update the control register.
