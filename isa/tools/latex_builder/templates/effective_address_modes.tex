...
It is not the address of the following instruction and not the address of a displacement or relocation field. The PC
term remains that instruction-start value throughout operand evaluation.
...
EXT0 has no default segment as a descriptor class. A concrete descriptor either encodes an SREG SEG(s), selects
fixed SS/CS through SP or PC, or explicitly uses the operation default data segment.
