...
\subsection{Golden Encodings}

The complete source cases are recorded in
\texttt{isa/reference/assembler\_golden\_vectors.yaml}. The following cases show the byte order used by that
...
\manualtablecaption{Canonical Assembly Golden Encodings}
