...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("-o", "--output", default="build/generated/decoder_table.json")
    parser.add_argument("--allocation", help="allocation_plan.json to include allocated decoder entries")
    ...
    payload = {
        ...
        "allocated_decoder_entries": load_allocated_entries(
