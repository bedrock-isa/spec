...
OWNER_SOURCE_PATHS = {
    "core": (
        ...
        SAIL_SOURCE_ROOT / "execution" / "core" / "effective_address.sail",
        SAIL_SOURCE_ROOT / "execution" / "core" / "integer_bits.sail",
        SAIL_SOURCE_ROOT / "instructions" / "integer" / "operands.sail",
        SAIL_SOURCE_ROOT / "instructions" / "integer" / "arithmetic.sail",
        SAIL_SOURCE_ROOT / "instructions" / "integer" / "data_control.sail",
        SAIL_SOURCE_ROOT / "instructions" / "integer" / "routing.sail",
        SAIL_SOURCE_ROOT / "system" / "state" / "system.sail",
        SAIL_SOURCE_ROOT / "memory" / "architecture" / "common.sail",
        SAIL_SOURCE_ROOT / "memory" / "architecture" / "save_cache.sail",
        SAIL_SOURCE_ROOT / "memory" / "architecture" / "translation.sail",
        SAIL_SOURCE_ROOT / "memory" / "architecture" / "system_requests.sail",
        SAIL_SOURCE_ROOT / "memory" / "architecture" / "stack_control.sail",
        SAIL_SOURCE_ROOT / "system" / "events" / "events.sail",
        SAIL_SOURCE_ROOT / "execution" / "repeat" / "repeat.sail",
        SAIL_SOURCE_ROOT / "instructions" / "control" / "control.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "local_execution.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "transaction_inputs.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "transaction_compute.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "transaction_flow.sail",
        ...
        SAIL_SOURCE_ROOT / "execution" / "core" / "resume_memory.sail",
    ...
    "fp": (
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "operation_catalog.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "transcendental_contract.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "register_pairs.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "types.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "environment.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "local_operations.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "request_contract.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "response_contract.sail",
        SAIL_SOURCE_ROOT / "instructions" / "floating_point" / "finalize.sail",
    ),
