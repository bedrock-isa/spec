...
SOURCE = ROOT / "isa" / "conformance" / "architecture_tables.yaml"
ISA_ROOT = ROOT / "isa"
OPERANDS_SOURCE = ROOT / "isa" / "instructions" / "definitions" / "operands.yaml"
RDPMC_TEMPLATE = (
    ROOT / "isa" / "instructions" / "definitions" / "instructions" / "RDPMC" / "details.tex.in"
)
RDPMC_OUTPUT = (
    ROOT / "isa" / "instructions" / "definitions" / "instructions" / "RDPMC" / "details.tex"
)
...
GENERATED_HEADER = (
    ...
    "% Source: isa/conformance/architecture_tables.yaml\n"
)
...
def output_files(data: dict[str, Any]) -> dict[Path, str]:
    ...
    return {
        ...
        ISA_ROOT / "memory" / "ordering" / "manual" / "cache_policies.tex": generated(
            render_cache_policies(data)
        ),
        ISA_ROOT / "memory" / "translation" / "manual" / "translation_cache_contract.tex": generated(
        ...
        ISA_ROOT / "memory" / "ordering" / "manual" / "atomic_memory_order_selectors.tex": generated(
