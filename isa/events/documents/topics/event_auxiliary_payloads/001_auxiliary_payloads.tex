...
Delivery-failure stages are independently allocated leaf events. Their (:ref:base.events.frame.EVENT_FRAME.EVENT_INFO.EVENT_CODE:) identifies the failed stage; the
...
14..12 & (:event-structure-target:base.events.payloads.BUS_FAILURE_ERROR_CODE.WALK_LEVEL:)\texttt{WALK\_LEVEL} & 0 outside a walk; 1 through 5 identify the PTE level\\
