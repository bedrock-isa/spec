...
The following fixed event codes are allocated by this specification. Each row answers only which symbolic event is
...
\BedrockTableCaption{Fixed Architectural Event-Code Allocations}
...
(:event-code:base.events.EXCEPTION.BREAKPOINT:)
