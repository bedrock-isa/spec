...
\manualformatreserved{reserved}{5}
\manualformatfield{UO}{1}
\manualformatfield{EDEPTH}{4}
...
\textbf{Field} & \textbf{Bits} & \textbf{Meaning}\\
\midrule
reserved & \texttt{15..11} & reads as zero and must be zero when written\\
...
reserved bits must be zero, and supplied \texttt{PM}, \texttt{EA}, \texttt{EDEPTH}, and \texttt{UO} must equal
...
FFLAGS holds accrued IEEE-754 floating-point exception flags. FSTATUS holds the matching exception-condition enables, rounding mode, and optional
