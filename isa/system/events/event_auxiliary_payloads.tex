...
10 & \texttt{PRECISE} & saved PC identifies the responsible instruction and saved architectural state precedes it\\
...
contains the final memory-system address available for the failed access. For a slot-addressed access, this is
