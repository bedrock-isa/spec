...
\Needspace{1.25in}
\BedrockTableCaption{Segment Register Operand Encoding}
\begin{BedrockLongTable}{@{}>{\raggedright\arraybackslash}p{0.60in}>{\raggedright\arraybackslash}p{0.50in}>{\raggedright\arraybackslash}p{0.70in}>{\raggedright\arraybackslash}p{3.60in}@{}}
\toprule
