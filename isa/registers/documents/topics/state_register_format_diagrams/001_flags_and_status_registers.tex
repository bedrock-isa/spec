...
\texttt{RF} & \texttt{3} & one-shot suppression of automatic single-step, execution-breakpoint, and memory-watchpoint stops\\
\texttt{TF} & \texttt{2} & requests post-success (:ref:base.events.EXCEPTION.SINGLE_STEP:) for a (:term:base.terms.trace_unit:) when \texttt{RF} is clear\\
