...
EXT1 and EXT2 are shared unchanged by EA, FEA, and VEA when a compact form cannot express the operand: explicit segment selection, indexed addressing,
...
\input{isa/ea/documents/fragments/extended_descriptor_reference_blocks.tex}
